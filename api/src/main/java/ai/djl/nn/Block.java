...
public interface Block {
     ...
     *
     * In most {@code Block} implementations, prediction is
     * the same calling the {@link Block#forward(ParameterStore, NDList)} method. However, in some
     * cases it can be different. In most {@code Block} implementation where predict is different
     * from forward, this default method must be overriden.
     *
     * @param parameterStore the parameter store
     * @param inputs the input NDList
     * @param params optional parameters
     ...
     */
    default NDList predict(ParameterStore parameterStore, NDList inputs, PairList<String, Object> params) {
