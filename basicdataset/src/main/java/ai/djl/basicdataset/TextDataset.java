...
public abstract class TextDataset extends RandomAccessDataset {
    ...
    public TextDataset(Builder<?> builder) {
        ...
        sourceTextData.setTokenizer(builder.sourceTokenizer);
        ...
        targetTextData.setTokenizer(builder.targetTokenizer);
    ...
    public abstract static class Builder<T extends Builder<T>> extends BaseBuilder<T> {
        ...
        protected Tokenizer targetTokenizer;
        protected boolean includeValidLength;
        protected int embeddingSize = 25;
        ...
        /**
         * Sets a {@link Tokenizer} to tokenize the source sentences.
         *
         * @param sourceTokenizer the {@link Tokenizer} to be set
         * @return this builder
         */
        public T setSourceTokenizer(Tokenizer sourceTokenizer) {
            this.sourceTokenizer = sourceTokenizer;
            return self();
        }

        /**
         * Sets a {@link Tokenizer} to tokenize the target sentences.
         *
         * @param targetTokenizer the {@link Tokenizer} to be set
         * @return this builder
         */
        public T setTargetTokenizer(Tokenizer targetTokenizer) {
